...
class QueryEditor extends React.Component {
  ...
  componentDidMount() {
    var CodeMirror = dynamic(() => import("codemirror"));
    dynamic(() => import("codemirror/addon/hint/show-hint"));
    dynamic(() => import("codemirror/addon/comment/comment"));
    dynamic(() => import("codemirror/addon/edit/matchbrackets"));
    dynamic(() => import("codemirror/addon/edit/closebrackets"));
    dynamic(() => import("codemirror/addon/lint/lint"));
    dynamic(() => import("codemirror/keymap/sublime"));
...
class ResultViewer extends React.Component {
  componentDidMount() {
    var CodeMirror = dynamic(() => import("codemirror"));
    dynamic(() => import("codemirror-graphql/results/mode"));
...
class VariableEditor extends React.Component {
  ...
  componentDidMount() {
    ...
    dynamic(() => import("codemirror/addon/lint/lint"));
    dynamic(() => import("codemirror/keymap/sublime"));
    dynamic(() => import("codemirror-graphql/variables/hint"));
    dynamic(() => import("codemirror-graphql/variables/lint"));
    dynamic(() => import("codemirror-graphql/variables/mode"));
